...
final readonly class ApprovalBinding
{
    ...
    /** Return the requesting actor. @return string Requesting actor. @since 0.1.0 */
    public function requesterId(): string
    {
        return $this->requesterId;
    }

    /** Return the protected action. @return string Exact action. @since 0.1.0 */
    public function action(): string
    {
        return $this->action;
    }

    /** Return the protected resource type. @return string Exact resource type. @since 0.1.0 */
    public function resourceType(): string
    {
        return $this->resourceType;
    }

    /** Return the protected resource identity. @return string Exact resource identity. @since 0.1.0 */
    public function resourceId(): string
    {
        return $this->resourceId;
    }

    /** Return the frozen resource version. @return int Exact resource version. @since 0.1.0 */
    public function resourceVersion(): int
    {
        return $this->resourceVersion;
    }

    /** Return the bound site. @return string Exact site. @since 0.1.0 */
    public function siteIdentifier(): string
    {
        return $this->siteIdentifier;
    }

    /** Return the optional bound organization. @return ?string Exact organization. @since 0.1.0 */
    public function organization(): ?string
    {
        return $this->organization;
    }

    /** Return the optional bound workspace. @return ?string Exact workspace. @since 0.1.0 */
    public function workspace(): ?string
    {
        return $this->workspace;
    }

    /** Return the frozen authority fingerprint. @return string Authority fingerprint. @since 0.1.0 */
    public function contextFingerprint(): string
    {
        return $this->contextFingerprint;
    }

    /** Return the canonical mutation digest. @return string Canonical mutation digest. @since 0.1.0 */
